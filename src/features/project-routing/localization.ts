...
const ENGLISH_LOCALIZATION: ProjectRoutingLocalization = {
	...
	modalEmptyStateText: 'No project matches the current query.',
	modalPlaceholder: 'Search projects',
	modalSelectInstructionPurpose: 'Select project',
...
const CHINESE_LOCALIZATION: ProjectRoutingLocalization = {
	...
	modalEmptyStateText: '当前没有匹配搜索条件的项目。',
	modalPlaceholder: '搜索项目',
	modalSelectInstructionPurpose: '选择项目',
	modalTitle: '选择项目',
